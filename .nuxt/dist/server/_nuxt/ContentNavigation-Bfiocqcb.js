...
import { toRef, isRef, defineComponent, useSlots, toRefs, computed, h, useSSRContext } from "vue";
...
import { q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify, b as useContentDisabled, u as useAsyncData } from "./query-CA-QbtpA.js";
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./client-db-C6NmjxHg.js").then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-Bfiocqcb.js.map

import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};export { k as closePrerenderer, l as localFetch } from './chunks/nitro/nitro.mjs';

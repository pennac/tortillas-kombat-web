import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { isRef, toValue as toValue$1, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, defineComponent, shallowRef, provide, cloneVNode, h, createElementBlock, toRaw, defineAsyncComponent, useSlots, Fragment, computed, unref, shallowReactive, Suspense, useSSRContext, createApp, reactive, mergeProps, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, effectScope, watch, nextTick, getCurrentScope, toRef, onUnmounted, onScopeDispose, onMounted, isReadonly, isShallow, isReactive } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/ofetch/dist/node.mjs';
import { j as baseURL, h as defu } from '../nitro/nitro.mjs';
...
import { getContext, executeAsync } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/vue-router/vue-router.node.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/ufo/dist/index.mjs';
import sync, { getFrameData } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/framesync/dist/es/index.mjs';
import { inertia, animate, velocityPerSecond, cubicBezier, bounceOut, bounceInOut, bounceIn, anticipate, backOut, backInOut, backIn, circOut, circInOut, circIn, easeOut, easeInOut, easeIn, linear } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/popmotion/dist/es/index.mjs';
import { number, complex, alpha, filter, px, progressPercentage, degrees, scale, color } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/style-value-types/dist/es/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/vue/server-renderer/index.mjs';
import { FlatMetaPlugin } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/paolopennac/Desktop/Desktop%20-%20Paolo%E2%80%99s%20MacBook%20Air/TortillasKombat/Website/TKV2/node_modules/nuxt/node_modules/unhead/dist/utils.mjs';
...
const __nuxt_page_meta = {
  layout: false
  // Hide header/footer for immersive reading
};
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CiLs6pf6.mjs')
  },
  {
    name: "lore-id",
    path: "/lore/:id()",
    component: () => import('./_id_-CfyuzpPW.mjs')
  },
  {
    name: "lore",
    path: "/lore",
    component: () => import('./index-DCA97qFK.mjs')
  },
  {
    name: "aviso-legal",
    path: "/aviso-legal",
    component: () => import('./aviso-legal-DiG0imWb.mjs')
  },
  {
    name: "comics-id",
    path: "/comics/:id()",
    meta: __nuxt_page_meta || {},
    component: () => import('./_id_-CX7-OTrX.mjs')
  },
  {
    name: "comics",
    path: "/comics",
    component: () => import('./index-Cy82r7AA.mjs')
  },
  {
    name: "politica-cookies",
    path: "/politica-cookies",
    component: () => import('./politica-cookies-BJwz0IWa.mjs')
  },
  {
    name: "politica-privacidad",
    path: "/politica-privacidad",
    component: () => import('./politica-privacidad-BoZMKiEW.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-BMsHBVep.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-DXuKIkbZ.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-Bfiocqcb.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-BRhTZErq.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-CBN739tv.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-jMwNpaA0.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-B7tmpeU3.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-vw7nRt0d.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-rk61Fkhk.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-7tFiQ75Y.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-B3X9Z90T.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DW0UymHX.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-J8mB8hOS.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Z3sInpqQ.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-C_SECIln.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useSeoMeta({
      ...
      description: "Un cómic interactivo y base de datos de lore en un mundo Steampunk-Culinario.",
      ogTitle: "Tortillas Kombat - The Steam Scroll",
      ogDescription: "Descubre Sartenópolis y sus técnicas de combate culinario.",
      ogImage: "/capitoli/capitulo1/Cover.jpeg",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full max-w-md mx-auto min-h-screen bg-white text-zinc-900 relative shadow-2xl overflow-hidden font-body" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BoEl1rwv.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CmQa4nst.mjs'));
...
export { __nuxt_component_0 as _, useGtag as a, useRoute as b, useRuntimeConfig as c, useNuxtApp as d, entry_default as default, asyncDataDefaults as e, createError as f, useRequestEvent as g, useRouter as h, encodeRoutePath as i, nuxtLinkDefaults as j, navigateTo as n, resolveRouteObject as r, useHead as u };
